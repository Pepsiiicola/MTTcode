function [x_k_history,w_birth,m_birth,P_birth,numTargetbirth,w_bar_k, m_bar_k, P_bar_k,x_k,x_k_w,x_k_P] = Alg11_GM_PHD_Filter(numTargetbirth,m_birth,P_birth,w_birth,F,Q,R,...
