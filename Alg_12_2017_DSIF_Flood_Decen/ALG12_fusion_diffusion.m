...
function [Results] = ALG12_fusion_diffusion(Fusion_center,match_threshold,ID_sensor,l,sensor)
...
%视域判断,权重调整
[InfComplete] = Alg12_FoV_judge(sensor,InfComplete,num_gm_component,N_sensor);

%匹配融合

[InfComplete] = Alg12_gm_merge(InfComplete,match_threshold);
