...
if ID_record ~= 0
    ...
    for i = ID_record+1 : N_sensor
        ...
        %===匹配部分===
        [Solution_match,Mat_match] = ALG6_Match(Match_part1,Match_part2,Matched_GM,cnt_matchedGm,match_threshold);
...
if ID_record == 0
    ...
    for i = 1:n_fusion
        ...
        W_AA = 1;
        for j = 1:n_w2f
            W_AA = W_AA * ( Matched_GM(i).gm{1,1}(1,j) )^( pai(j) );
        end
