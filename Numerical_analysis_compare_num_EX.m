...
if Config.AlgPerformance(4) == 1 
    ...
    OSPA_N = zeros(size(Config.AlgCompare,2),Num_monte);
    for i = 1:Num_monte
        OverlapFoV_F(1,i) = DataSave(i).OverlapFoV;
        for j = 1:size(Config.AlgCompare,2)
            OSPA_N(j,i) = DataSave( i ).ALG(j).Err_num;
        end
    end
    %  7 个算法
    h_fov_1 = plot( OverlapFoV_F, OSPA_N(1,:),'-kp','Markerface','y','MarkerSize',10);
    h_fov_2 = plot( OverlapFoV_F, OSPA_N(2,:),'-r+','MarkerSize',10);
    h_fov_3 = plot( OverlapFoV_F, OSPA_N(3,:),'-rx','MarkerSize',10);
    h_fov_4 = plot( OverlapFoV_F, OSPA_N(4,:),'-kh','MarkerSize',10);
    h_fov_5 = plot( OverlapFoV_F, OSPA_N(5,:),'-b^','MarkerSize',10);
    h_fov_6 = plot( OverlapFoV_F, OSPA_N(6,:),'-b<','MarkerSize',10);
    h_fov_7 = plot( OverlapFoV_F, OSPA_N(7,:),'-bo','MarkerSize',10);
%     axis([0,100,0,150]);
...
elseif Config.AlgPerformance(5) == 1 
    ...
    %  7 个算法
    h_com_1 = plot( OverlapCom_F, OSPA_N(1,:),'-kp','Markerface','y','MarkerSize',10);
    h_com_2 = plot( OverlapCom_F, OSPA_N(2,:),'-r+','MarkerSize',10);
    h_com_3 = plot( OverlapCom_F, OSPA_N(3,:),'-rx','MarkerSize',10);
    h_com_4 = plot( OverlapCom_F, OSPA_N(4,:),'-kh','MarkerSize',10);
    h_com_5 = plot( OverlapCom_F, OSPA_N(5,:),'-b^','MarkerSize',10);
    h_com_6 = plot( OverlapCom_F, OSPA_N(6,:),'-b<','MarkerSize',10);
    h_com_7 = plot( OverlapCom_F, OSPA_N(7,:),'-bo','MarkerSize',10);
    %     axis([0,100,0,150]);
...
%     OSPA_F(1,5) = 39.570;
%     OSPA_F(1,4) = 23.690;
    h_PD_1 = plot( PD_F, OSPA_N(1,:),'-kp','Markerface','y','MarkerSize',10);
    h_PD_2 = plot( PD_F, OSPA_N(2,:),'-r+','MarkerSize',10);
    h_PD_3 = plot( PD_F, OSPA_N(3,:),'-rx','MarkerSize',10);
%     h_PD_4 = plot( PD_F, OSPA_N(4,:),'-kh','MarkerSize',10);
    h_PD_5 = plot( PD_F, OSPA_N(5,:),'-b^','MarkerSize',10);
    h_PD_6 = plot( PD_F, OSPA_N(6,:),'-b<','MarkerSize',10);
    h_PD_7 = plot( PD_F, OSPA_N(7,:),'-bo','MarkerSize',10);
    %     axis([0,100,0,150]);
